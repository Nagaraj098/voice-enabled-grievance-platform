...
//     isConnected = false,
//     error = null,
//     speakingMessageId = null,  // ✅ which message is currently being spoken
//   } = useTranscript();

//   // ✅ Tell VoiceOrb when AI is speaking
//   useEffect(() => {
//     setSpeaking?.(speakingMessageId !== null);
//   }, [speakingMessageId, setSpeaking]);
...
//           key={msg.id || index}
//           message={msg}
//           // ✅ Google Meet style — highlight the exact message being spoken

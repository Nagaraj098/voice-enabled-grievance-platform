...
# - user_name: "{session.user_name or 'check conversation'}"
...
#                 # 🔥 STEP 4: TTS — ✅ sentence by sentence streaming
#                 if stop_event.is_set():
#                     break

#                 sentence_count = 0
#                 async for audio_b64 in tts.synthesize_sentences(ai_response):
#                     # ✅ Stop TTS if call ended
#                     if stop_event.is_set():
#                         print("🛑 Stop event — cancelling remaining TTS")
#                         break
